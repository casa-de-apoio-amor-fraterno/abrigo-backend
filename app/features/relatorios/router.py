...
from app.features.relatorios.schemas import PeriodoRelatorio, RelatorioResumoResponse
...
def resumo_estadias(
    ...
    return RelatorioResumoResponse(itens=service.resumo_estadias(db, periodo))
...
def relatorio_estadias(
    ...
    return Response(content=service.gerar_pdf_estadias(db, periodo), media_type="application/pdf")
...
def resumo_emprestimos(
    ...
    return RelatorioResumoResponse(itens=service.resumo_emprestimos(db, periodo))
...
def relatorio_emprestimos(
    ...
    return Response(content=service.gerar_pdf_emprestimos(db, periodo), media_type="application/pdf")
